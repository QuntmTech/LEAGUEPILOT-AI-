...
- Tabs/filters for **All**, **Lineup**, **Waivers**, **Trades**, **Approved**, **Dismissed**.
...
- Integrations: ESPN connection status. Leave notifications as a clearly marked later enhancement if
  the existing site does not already support them.
